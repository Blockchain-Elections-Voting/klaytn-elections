    ...
    <div className="relative inline-block text-left">
      ...
      >
        <button
          ...
          className="flex h-8 w-44 text-white items-center justify-center overflow-hidden rounded border border-indigo-700 transition-all duration-75 focus:outline-none active:scale-95 sm:h-9 sm:w-44"
        >
